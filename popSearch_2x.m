        ...
        switch curState
            case expState.Init_Exp
                infoText.instruction=['Visual Search \n', ...
                    ...
                    'If there is a pop-out target, please pay your attention to it.\n ', ...
                        ...
                        switch exp.seq(expInfo.curTrial,5)
                            case 1
                                infoText.instruction=['Block ' num2str(floor(expInfo.curTrial/blk_trials)+1) ,...
                                    ...
                                    '\n when you are ready, please press left button to start the block'];
                                v.dispText(infoText.instruction);
                                stim.trigger=1111;
                            case 2
                                infoText.instruction=['Block ' num2str(floor(expInfo.curTrial/blk_trials)+1) ,...
                 ...
                 if GetSecs - timeTag >= curState.duration
                    ...
                    if expInfo.curTrial >= exp.maxTrls
                        ...
                        if mod(expInfo.curTrial,blk_trials) == 0
                            ...
                            curState=expState.Init_Exp_Wait;        %added for trying, possibly should be deleted
